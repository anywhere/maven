...
public class ConnectionPoolTest2 extends AbstractJUnit4SpringContextTests {
    
    private static Logger log = LoggerFactory.getLogger(ConnectionPoolTest2.class);
    ...
    public void testTomcatJdbc() throws Exception {
        ...
        for (int i = 0; i < 10000; i++) {
            // ModelDaoIF dao = (ModelDaoIF) ctx.getBean("SimpleModelDao");
            // Work work = new HibernatePooxTest().new Work();
            // work.setDao(dao);
